...
class A8 extends JFrame
{
  ...
  public A8()
  {
	  ...
	  Nxt.addActionListener(new ActionListener() {
	    ...
	    a9.getlableString(re1String(), re2String(),re3String(),re4String(),re5String(),re6String(),re7String(),val8);
	  ...
	  Nxt.setBorder(bored);
	      ...
	      JLabel l=new JLabel(new ImageIcon("C:\\Users\\TAK\\Desktop\\Tech Hunt Images\\A8.jpg"));
