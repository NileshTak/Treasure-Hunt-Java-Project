...
class A7 extends JFrame
{
  ...
  public A7()
  {
	 ...
	 a8.getlableString(re1String(), re2String(),re3String(),re4String(),re5String(),re6String(),val7);
	  ...
	  Nxt.setBorder(bored);
	      ...
	      JLabel l=new JLabel(new ImageIcon("C:\\Users\\TAK\\Desktop\\Tech Hunt images\\A7.jpg"));
