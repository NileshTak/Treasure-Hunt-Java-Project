...
class C9
{
  ...
  public C9()
  {
	  ...
	  Nxt.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	    	     ...
	    	     String val9 = textField9.getText();					
		    	 	c10.getlableString(re1String(), re2String(),re3String(),re4String(),re5String(),re6String(),re7String(),re8String(),val9);
	  ...
	  Nxt.setBorder(bored);
	      ...
	      JLabel l=new JLabel(new ImageIcon("C:\\Users\\TAK\\workspace\\Tech Hunt\\src\\image\\C9.jpg"));
