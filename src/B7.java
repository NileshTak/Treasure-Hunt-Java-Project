...
class B7 extends JFrame
{
  ...
  public B7()
  {
	  ...
	  Nxt.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	    	    ...
	    	    B8 b8 = new B8();
	    	     b8.getTimer();
	 			String val7 = textField7.getText();					
	 b8.getlableString(re1String(), re2String(),re3String(),re4String(),re5String(),re6String(),val7);
	  ...
	  Nxt.setBorder(bored);
	      ...
	      JLabel l=new JLabel(new ImageIcon("C:\\Users\\TAK\\workspace\\Tech Hunt\\src\\image\\B7.jpg"));
	      ...
	      textField7.setBounds(250,300,420,40);
	      l.add(textField7);
          l.add(home);
	      l.add(Nxt); 
  ...
  public void getlableString(String stA6,String stA5,String stA4,String stA3,String stA2,String stA1)
  {
	  lblv6 = stA6;
	  lblv5 = stA5;
	  lblv4 = stA4;
