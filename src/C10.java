...
class MyButtonC extends JButton {
...
public class C10 extends JFrame  {
    ...
    private ArrayList<MyButtonC> buttons;
 ...
 static int Y;
    ...
    private void initUI() {
	  ...
	  p.setLayout(new FlowLayout());
        ...
        try {
            ...
            Logger.getLogger(C10.class.getName()).log(
            ...
            for (int j = 0; j < 3; j++) {
                ...
                image = createImage(new FilteredImageSource(resized.getSource(),
                        new CropImageFilter(j * width / 3, i * height / 4,
                                (width / 3), height / 4)));
                MyButtonC button = new MyButtonC(image);
                button.putClientProperty("position", new Point(i, j));

                if (i == 3 && j == 2) {
                    lastButton = new MyButtonC();
    	...
    	pic = new JPanel();
     	 ...
     	 JLabel l=new JLabel(new ImageIcon("C:\\Users\\TAK\\workspace\\Tech Hunt\\src\\image\\C10.jpg"));
    ...
    private BufferedImage loadImage() throws IOException {
        ...
        BufferedImage bimg = ImageIO.read(new File("C:\\Users\\TAK\\workspace\\Tech Hunt\\src\\image\\our-logo.jpg"));
